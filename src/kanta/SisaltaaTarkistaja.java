...
/**
 * Tarkistaja, joka tarkistaa, että jono sisältää vain sallittuja merkkejä. Tässä tapauksessa käytetään vain päivämäärän tarkistamiseen.
 * @author Riku
 * @version 23.4.2020
 *
 */
